...
pub struct RenderTableRc<'s, TItem: TableItem + 'static, MyIterator: Iterator<Item = &'s Rc<TItem>>>
{
...
impl<'s, TItem: TableItem + 'static, MyIterator: Iterator<Item = &'s Rc<TItem>>>
    RenderTableRc<'s, TItem, MyIterator>
{
